...
Editorial, precise, understated-technical. The voice is terse, confident, and concrete — a developer who cares about typography, not a SaaS landing page. Three words: **measured, exacting, grounded.** The interface should evoke quiet authority and trust, the feeling of reading a well-set technical journal rather than a startup pitch deck. Let the work speak; never oversell. No marketing fluff, no exclamation points, no hype.

## Anti-references

Explicitly avoid, by name:
- Generic SaaS / AI-startup landing-page templates
- Inter or system-default fonts
...
This should not look like a venture-funded AI tool's marketing site. It should look like an engineer's considered personal page.
...
- **Production-grade by default.** Accessibility, reduced-motion, and performance are part of the craft on display, not afterthoughts.
